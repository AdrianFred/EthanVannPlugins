...
public class ExamplePluginTest {
    public static void main(String[] args) throws Exception {
        ExternalPluginManager.loadBuiltin(EthanApiPlugin.class, PacketUtilsPlugin.class, LogItemPlugin.class, ExamplePlugin.class, ItemDropperPlugin.class, InventoryEquipperPlugin.class, JadAutoPrayersPlugin.class, PiggyUtilsPlugin.class, AttackGoblinHotkeyPlugin.class, LucidCombatPlugin.class);
        RuneLite.main(args);
    }
}
