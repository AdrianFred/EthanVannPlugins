package com.hunterPlugins.lucidcombat;

import com.example.EthanApiPlugin.Collections.ETileItem;
import com.google.inject.Provides;
import com.hunterPlugins.api.item.SlottedItem;
import com.hunterPlugins.api.spells.Runes;
import com.hunterPlugins.api.spells.WidgetInfo;
import com.hunterPlugins.api.utils.*;
...
public class LucidCombatPlugin extends Plugin implements KeyListener
{
    ...
    private boolean handleAutoCombat()
    {
        ...
        if (targetDeadOrNoTarget() || (config.multipleTargets() && CombatUtils.isInMultiwayCombat()))
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    else if (interactingWithUs == null)
                    {
    ...
    private NPC getEligibleTarget()
    {
        ...
        return NpcUtils.getNearestNpc(config.multipleTargets() && CombatUtils.isInMultiwayCombat() ? multiTargetFilter.and(restOfFilter) : singleTargetFilter.and(restOfFilter));
    }
    ...
    private boolean targetDeadOrNoTarget()
    {
        ...
        NPC interactingWithUs = getEligibleNpcInteractingWithUs();
        if (interactingWithUs != null && !CombatUtils.isInMultiwayCombat())
        {
